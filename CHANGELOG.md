...
- Accessing the legacy `KKLayout` binding now emits Julia's standard
  deprecation notice directing users to `MDSLayout`. The implemented
  algorithm remains classical multidimensional scaling.
